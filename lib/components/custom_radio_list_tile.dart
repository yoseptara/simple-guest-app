...
///
/// To show the [CRadioListTile] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool dartpad}
...
class CRadioListTile<T> extends StatelessWidget {
  ...
  /// {@macro flutteridgets.Focus.autofocus}
  ...
  /// If specified, [shape] defines the shape of the [CRadioListTile]'s [InkWell] border.
  // final ShapeBorder? shape;

  /// If specified, defines the background color for `RadioListTile` when
  /// [CRadioListTile.selected] is false.
  // final Color? tileColor;

  /// If non-null, defines the background color when [CRadioListTile.selected] is true.
  ...
  /// {@macro flutteridgets.Focus.focusNode}
